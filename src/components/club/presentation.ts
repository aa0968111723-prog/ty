...
export const TEXT = {
  en: {
    ...
    officialRules:
      "Official club rules: 60 seconds, each answer randomly chooses word meaning or ink color, +100 for a correct answer / +200 for a combo / −50 for a mistake.",
    slow: "Slow",
    normal: "Normal",
    fast: "Fast",
    rush: "Rush",
    slowHint: "Random rule after each answer",
    normalHint: "Random rule after each answer",
    fastHint: "Random rule after each answer",
    rushHint: "Random rule after each answer",
    howToSwitch: "After each answer, the next task is randomly word meaning or ink color.",
    timeLeft: "Time left",
    score: "Score",
    combo: "Combo",
  ...
  zh: {
    ...
    officialRules:
      "目前是社博正式規則：60 秒，每答完一題隨機換成字面意思或視覺顏色，答對 +100／連擊 +200／答錯 −50。",
    slow: "慢",
    normal: "一般",
    fast: "快",
    rush: "極快",
    slowHint: "每答一題隨機換規則",
    normalHint: "每答一題隨機換規則",
    fastHint: "每答一題隨機換規則",
    rushHint: "每答一題隨機換規則",
    howToSwitch: "答完一題，下一題會隨機是字面意思或視覺顏色。",
    timeLeft: "剩餘",
    score: "分數",
    combo: "連擊",
