...
function GearIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="M19.4 12.9c.06-.3.1-.6-.1-.9s-.04-.6-.1-.9l2-1.5-1.9-3.3-2.3.7c-.5-.4-1-.7-1.6-.9L15 3h-6l-.6 2.1c-.6.2-1.1.5-1.6.9l-2.3-.7L3.6 8.6l2 1.5c-.06.3-.1.6-.1.9s.04.6.1.9l-2 1.5 1.9 3.3 2.3-.7c.5.4 1.1.7 1.6.9L15 21h-6l-.6-2.1c-.6-.2-1.1-.5-1.6-.9l-2.3.7-1.9-3.3 2-1.5Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
    </svg>
  );
}
