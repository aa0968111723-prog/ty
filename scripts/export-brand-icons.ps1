...
$brandSource = [System.Drawing.Bitmap]::new((Join-Path $brandRoot 'club-logo.png'))
try {
  ...
  foreach ($brandSize in @(32, 48, 180, 192, 512)) {
    ...
    try {
      ...
      $brandBitmap.Save((Join-Path $brandRoot "club-icon-3d-$brandSize.png"), [System.Drawing.Imaging.ImageFormat]::Png)
