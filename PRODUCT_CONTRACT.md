...
- 招生 Google Form（2026招生狀況表單-上）仍是夥伴人工輸入入口。已登入夥伴使用 `/follow-up`「接引人快速填表」產生完整 `/viewform` PREFILL（姓名、電話、系級、遊戲完成時間、遊戲關主、submissionId 可改；接引人預設為目前選的夥伴，不覆蓋遊戲關主）。已填過的學生不再出現。總表既有公式維持不變。
